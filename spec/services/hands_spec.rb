...
RSpec.describe Hands, type: :service do
  ...
  describe "#search_hands" do
    let(:search_hands){ Hands.search_hands(cards) }

    context "when the hand is Straight Flush" do
      let(:cards) { "H13 H1 H11 H12 H10" }
      it "returns \"ストレートフラッシュ\"" do
        expect(search_hands[:name]).to eq "ストレートフラッシュ"
      end
      it "returns 8" do
        expect(search_hands[:score]).to eq 8
      end
    end
    ...
    context "when the hand is Four of a kind" do
      ...
      it "returns \"フォーカード\"" do
        expect(search_hands[:name]).to eq "フォーカード"
      end
      it "returns 7" do
        expect(search_hands[:score]).to eq 7
      end
    end
    ...
    context "when the hand is Full House" do
      ...
      it "returns \"フルハウス\"" do
        expect(search_hands[:name]).to eq "フルハウス"
      end
      it "returns 6" do
        expect(search_hands[:score]).to eq 6
      end
    end
    ...
    context "when the hand is Flush" do
      ...
      it "returns \"フラッシュ\"" do
        expect(search_hands[:name]).to eq "フラッシュ"
      end
      it "returns 5" do
        expect(search_hands[:score]).to eq 5
      end
    end
    ...
    context "when the hand is Straight" do
      ...
      it "returns \"ストレート\"" do
        expect(search_hands[:name]).to eq "ストレート"
      end
      it "returns 4" do
        expect(search_hands[:score]).to eq 4
      end
    end
    ...
    context "when the hand is Three of a kind" do
      ...
      it "returns \"スリーカード\"" do
        expect(search_hands[:name]).to eq "スリーカード"
      end
      it "returns 3" do
        expect(search_hands[:score]).to eq 3
      end
    end
    ...
    context "when the hand is Two pair" do
      ...
      it "returns \"ツーペア\"" do
        expect(search_hands[:name]).to eq "ツーペア"
      end
      it "returns 2" do
        expect(search_hands[:score]).to eq 2
      end
    end
    ...
    context "when the hand is Pair" do
      ...
      it "returns \"ワンペア\"" do
        expect(search_hands[:name]).to eq "ワンペア"
      end
      it "returns 1" do
        expect(search_hands[:score]).to eq 1
      end
    end
    ...
    context "when the hand is High card" do
      ...
      it "returns \"ハイカード\"" do
        expect(search_hands[:name]).to eq "ハイカード"
      end
      it "returns 0" do
        expect(search_hands[:score]).to eq 0
      end
    end
  end
end