  ...
  describe "#judge_cards" do
    ...
    context "when the hand is Four of a kind" do
      ...
      it "returns \"フォーカード\"" do
        expect(judge[:name]).to eq "フォーカード"
      end
      it "returns 7" do
        expect(judge[:score]).to eq 7
      end
    end
    ...
    context "when the hand is Full House" do
      ...
      it "returns \"フルハウス\"" do
        expect(judge[:name]).to eq "フルハウス"
      end
      it "returns 6" do
        expect(judge[:score]).to eq 6
      end
    end
    ...
    context "when the hand is Flush" do
      ...
      it "returns \"フラッシュ\"" do
        expect(judge[:name]).to eq "フラッシュ"
      end
      it "returns 5" do
        expect(judge[:score]).to eq 5
      end
    end
    ...
    context "when the hand is Straight" do
      ...
      it "returns \"ストレート\"" do
        expect(judge[:name]).to eq "ストレート"
      end
      it "returns 4" do
        expect(judge[:score]).to eq 4
      end
    end
    ...
    context "when the hand is Three of a kind" do
      ...
      it "returns \"スリーカード\"" do
        expect(judge[:name]).to eq "スリーカード"
      end
      it "returns 3" do
        expect(judge[:score]).to eq 3
      end
    end
    ...
    context "when the hand is Two pair" do
      ...
      it "returns \"ツーペア\"" do
        expect(judge[:name]).to eq "ツーペア"
      end
      it "returns 2" do
        expect(judge[:score]).to eq 2
      end
    end
    ...
    context "when the hand is Pair" do
      ...
      it "returns \"ワンペア\"" do
        expect(judge[:name]).to eq "ワンペア"
      end
      it "returns 1" do
        expect(judge[:score]).to eq 1
      end
    end
    ...
    context "when the hand is High card" do
      ...
      it "returns \"ハイカード\"" do
        expect(judge[:name]).to eq "ハイカード"
      end
      it "returns 0" do
        expect(judge[:score]).to eq 0
      end
    end
  end
end